...
_minimum_jaxlib_version = "0.4.13"
_minimum_jax_version = "0.4.13"
...
def get_minimum_jax_version():
    """Get minimum JAX version required."""
    return _minimum_jax_version

def get_minimum_jaxlib_version():
    """Get minimum jaxlib version required."""
    return _minimum_jaxlib_version
